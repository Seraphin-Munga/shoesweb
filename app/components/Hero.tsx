...
const FALLBACK: ApiHeroContent = {
  badge:           "Summer Collection — 2026",
  headline:        "Step Into Your",
  accent:          "World.",
  subtext:         "Premium footwear engineered for every stride. Where performance meets refined design.",
  cta1Label:       "Shop Now",
  cta2Label:       "Browse Collections",
  promoLabel:      "Limited Offer",
  promoTitle:      "Free Shipping",
  promoBody:       "Orders over $150",
  bestSellerName:  "Air Vortex Pro",
  bestSellerPrice: "$189.99",
};
...
export default async function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden bg-white">
      ...
      {/* ── White gradient overlay — left strong, right transparent ── */}
